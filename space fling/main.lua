...
gfxQuad:setRect ( screen_width/2*-1,screen_height/2*-1,screen_width/2,screen_height/2)
prop = MOAIProp2D.new ()
prop:setDeck ( gfxQuad )
prop:setScl ( 1,1)
layer2:insertProp ( prop )

layer1:setParallax ( 0.75,0.75 )
gfxQuad = MOAIGfxQuad2D.new ()
...
function clickCallback ( down )
	...
	if down==false then
		mousedown=false
		bx,by= body:getPosition()
		body:applyForce( mouseX-bx *1000, mouseY-by *1000,bx,by)
