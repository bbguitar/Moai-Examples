...
fadeoutAction = logo:seekColor ( 0,0,0,0, 5 ) -- fadeout	
end
...
logoGfx:setRect ( -480, -240, 480, 480)
...
fadeinAction = logo:seekColor ( 1, 1, 1, 1, 5) -- fadein
