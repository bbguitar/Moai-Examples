...
function clickCallback ( down )
	...
	if down then
		--print ("Mouse down x="..mouseX)
		if mouseX<-1 then move_left() end
		if mouseX>1 then move_right() end
		if mouseY>1 then move_up() end
		if mouseY<-1 then move_down() end
	end
end
